...
// Draw Arcs
        ...
        newSvg.append("text").text("More People").attr("transform", "translate(" + 20 + "," + 12 + ")");
        newSvg.append("text").text("Less People").attr("transform", "translate(" + 20 + "," + 200 + ")");
...
//Label 1
  lineArea.append("text").attr("transform", "translate(550,83)")
  ...
  lineArea.append("text")
          ...
          .transition().duration(1000).ease(d3.easeLinear).attr("opacity", 1);
//Label 2
  lineArea.append("text").attr("transform", "translate(550,250)")
  ...
  lineArea.append("text")
          ...
          .transition().duration(1000).ease(d3.easeLinear).attr("opacity", 1);
//Label 3
  lineArea.append("text").attr("transform", "translate(550,300)")
  ...
  lineArea.append("text")
          .text("264 mi")
          .attr("class", "annotation")
          .attr("transform", "translate(580,320)")
          .attr("opacity", 0)
          .transition().duration(1000).ease(d3.easeLinear).attr("opacity", 1);
